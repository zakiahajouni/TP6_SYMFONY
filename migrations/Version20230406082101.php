 ...
 */
final class Version20230406082101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP category_id, CHANGE nom nom VARCHAR(255) NOT NULL');
    }
}
